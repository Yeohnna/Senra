...
- **Endpoint**：`GET https://app-bkdcegaumsjl-api-oLpZ74noWOMa-gateway.appmiaoda.com/idcard`
...
async function verifyIdCardTwoFactor(
  ...
  const response = await fetch(
    `https://app-bkdcegaumsjl-api-oLpZ74noWOMa-gateway.appmiaoda.com/idcard?${params.toString()}`,
    {
      method: "GET",
      headers: {
