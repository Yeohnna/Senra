...
| 接口 | 方法 | Endpoint |
|------|------|----------|
| 提交任务 | POST | `https://app-bkdcegaumsjl-api-ra5EZDjVKkXa-gateway.appmiaoda.com/image-generation/submit` |
| 查询状态 | POST/GET | `https://app-bkdcegaumsjl-api-VaOwP2jDmAga-gateway.appmiaoda.com/image-generation/task` |
