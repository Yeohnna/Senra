...
- **Endpoint**：`POST https://app-bkdcegaumsjl-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-bkdcegaumsjl-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
